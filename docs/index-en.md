<h1> Rapid deployment of the Metabase on Alibaba Cloud compute nest </h1>
...
<p>Metabase is an open-source business intelligence platform. You can use Metabase to ask questions about your data, or embed Metabase in your app to let your customers explore their data on their own.</p>
<p>
    GitHub address of this project: <a href='https://github.com/metabase/metabase'>https://github.com/metabase/metabase</a></p>

<h2> Prerequisites </h2>

<p><font style="color:rgb(51, 51, 51);"> To deploy a Metabase community edition service instance, you need to
...
<p><font style="color:rgb(51, 51, 51);"> The cost of Metabase community edition deployment in computing nest
...
<p> This service requires ECS instance can access Metabase server from public network. </p>
...
<ol>
    <li> Visit the compute nest Metabase<a
            href="https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=Metabase社区版">
    ...
    <li> Access the Metabase dashboard</li> <img src="./13.jpg" alt=""/><img src="./14.jpg" alt=""/>
</ol>
